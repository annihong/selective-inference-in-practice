...
```{r}
r <- bootstrap_process(data=boston_dat, B=1000, outcomes=outcomes)
  ...
  train_prop <- mean(train_sig > 0)
  test_prop <- mean(test_sig > 0)
  train_prop
  test_prop
  ...
  # train_prop_sandwich <- mean(train_sig_sandwich > 0)
  # test_prop_sandwich <- mean(test_sig_sandwich > 0)
```