...
```{r}
plot(1:50, prop, type = "l", col="blue", ylim = c(0,1), ylab = "P(at least 1 sig non-intercept term) ", main = "FDR under global null, n = 100", xlab = "Trial")
lines(1:50,prop_robust, col="red")
...
repeated_boston <- function(i, raw_data){
  ...
  res <- sapply(p_grid, get_r_sq_box, outcome=outcome, var="nox")
